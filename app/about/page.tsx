    ...
    <div className="text-black text-center py-6 px-6 md:px-28">
      ...
      <div className="flex flex-col mt-8 md:flex-row justify-evenly">
        <div className="text-left w-auto tracking-wide leading-8 md:w-1/2">
          ...
          <p className="mb-8">
            I am currently working as a front-end developer at a digital agency
            in Shoreditch where I use JavaScript to build and maintain large
            scale web applications for a wide range of clients.
          </p>
          <p className="mb-8">
            ...
            developed strong programming skills in Ruby, Java, and JavaScript
            with a particular focus on web development. The course involved
            around 800 hours of class time and personal study, daily pair
            programming labs and three full-stack projects (you can check those
            out{" "}
        ...
        <div className="w-full text-center md:w-[45%] md:ml-6">
          <Image
            src={profile}
            alt="Gregor Cox"
            className="h-auto w-[90%] md:max-w-96 rounded-lg shadow-lg"
          />
        </div>
      </div>
    </div>
